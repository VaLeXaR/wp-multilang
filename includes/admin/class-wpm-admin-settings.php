									...
									<td>
										<select class="wpm-flags" name="wpm_languages[<?php echo $i; ?>][flag]" title="<?php esc_attr_e( 'Flag', 'wp-multilang' ); ?>">
											...
											<?php foreach ( $flags as $flag ) { ?>
												<option value="<?php esc_attr_e( $flag ); ?>" style="background-image: ('<?php echo esc_url( wpm_get_flag_url( $flag ) ); ?>')" <?php selected( $language['flag'], $flag ); ?>><?php esc_attr_e( pathinfo( $flag, PATHINFO_FILENAME ) ); ?></option>
											<?php } ?>
										</select>
						...
						<tr>
							...
							<td>
								<select class="wpm-flags" name="wpm_languages[{{ data.count }}][flag]" title="<?php esc_attr_e( 'Flag', 'wp-multilang' ); ?>">
									<option value=""><?php esc_attr_e( '&mdash; Select &mdash;' ); ?></option>
									<?php foreach ( $flags as $flag ) { ?>
										<option value="<?php esc_attr_e( $flag ); ?>" style="background-image: ('<?php echo esc_url( wpm_get_flag_url( $flag ) ); ?>')"><?php esc_attr_e( pathinfo( $flag, PATHINFO_FILENAME ) ); ?></option>
									<?php } ?>
								</select>
							</td>
						</tr>
