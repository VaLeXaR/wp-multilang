 ...
 * @category Class
 */
class WPM_Register_WP_Admin_Settings {
	 ...
	 *
	 * @param $object The object that contains the settings to register.
	...
	public function __construct( $object, $type ) {
		...
		if ( 'page' === $type ) {
			add_filter( 'wpm_settings_groups', array( $this, 'register_page_group' ) );
			add_filter( 'wpm_settings-' . $this->object->get_id(),  array( $this, 'register_page_settings' ) );
		}
	}
