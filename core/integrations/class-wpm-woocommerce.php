...
class WPM_WooCommerce {
	...
	public function __construct() {
		add_filter( 'woocommerce_product_get_name', 'wpm_translate_string', 5 );
		add_filter( 'woocommerce_product_get_description', 'wpm_translate_string', 5 );
		add_filter( 'woocommerce_product_get_short_description', 'wpm_translate_string', 5 );
