 ...
 *
 * @class    GP_Settings_API
 * @package  GamePortal/Abstracts
 * @category Abstract Class
 * @author   VaLeXaR
 */
abstract class GP_Settings_API {

	/**
	 * The plugin ID. Used for option names.
	 * @var string
	 */
	public $plugin_id = 'game_portal_';
	...
	public function get_form_fields() {
		return apply_filters( 'game_portal_settings_api_form_fields_' . $this->id, array_map( array( $this, 'set_defaults' ), $this->form_fields ) );
	}
	...
	public function process_admin_options() {
		...
		return update_option( $this->get_option_key(), apply_filters( 'game_portal_settings_api_sanitized_fields_' . $this->id, $this->settings ) );
	}
	...
	public function display_errors() {
		if ( $this->get_errors() ) {
			echo '<div id="game_portal_errors" class="error notice is-dismissible">';
	...
	public function get_tooltip_html( $data ) {
		...
		return $tip ? gp_help_tip( $tip, true ) : '';
	}
			...
			<td class="forminp">
				<fieldset>
					...
					<?php if ( $data['select_buttons'] ) : ?>
						<br/><a class="select_all button" href="#"><?php _e( 'Select all', 'game-portal' ); ?></a> <a class="select_none button" href="#"><?php _e( 'Select none', 'game-portal' ); ?></a>
					<?php endif; ?>
				</fieldset>
			</td>
		</tr>
	...
	public function generate_title_html( $key, $data ) {
		...
		?>
			...
			<h3 class="gp-settings-sub-title <?php echo esc_attr( $data['class'] ); ?>" id="<?php echo esc_attr( $field_key ); ?>"><?php echo wp_kses_post( $data['title'] ); ?></h3>
	...
	public function validate_select_field( $key, $value ) {
		$value = is_null( $value ) ? '' : $value;
		return gp_clean( stripslashes( $value ) );
	}
	...
	public function validate_multiselect_field( $key, $value ) {
		return is_array( $value ) ? array_map( 'gp_clean', array_map( 'stripslashes', $value ) ) : '';
	}
}
